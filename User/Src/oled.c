...
{
    HAL_I2C_Mem_Write(oled_i2c, 0x78, 0x00, I2C_MEMADD_SIZE_8BIT, &Command, 1, HAL_MAX_DELAY);
}
...
{
    HAL_I2C_Mem_Write(oled_i2c, 0x78, 0X40, I2C_MEMADD_SIZE_8BIT, Data, Count, HAL_MAX_DELAY);
}
